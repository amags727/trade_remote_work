...
v_lcp_init = dh9_run_inner_loop(v_hjb_init, true, base_params);
...
parfor i = 1:length(phi_vec)
 ...
 last_v = dh9_run_inner_loop(init_v.hjb,false, local_params);
 graph_output{i}= dh10_graph_output(last_v, local_params, false);
end
