...
A_tilde = A_bar - sigma_a^2- (a_act - z_act).^2 - Sigma;

% guess v_0; 
% Sigma_0 s.t. -Sigma^2*sigma_a^-2 - 2*theta*Sigma + Q = 0 
R_0 = sigma_a^2;
Sigma_0 = -theta*R_0 + sqrt(theta^2*R_0^2 + Q*R_0);
A_tilde_0 = A_bar - sigma_a^2- Sigma_0;
V_0 = repmat(A_tilde_0*pi_bar / rho, len_state,1);
