...
## export   
write_parquet(birth_data,'9_age_data/9b_firm_lvl_birth_data.parquet')

# generate "birth" vars needed for customs data  ------------------------------
customs_birth_vars = c('country_entrance_year', 'streak_start')
birth_data = import_file('9_age_data/9b_firm_lvl_birth_data.parquet', 
...
write_parquet(customs_birth_data,'9_age_data/9c_firm_ctry_lvl_birth_data.parquet')
# clear ------------------------------
