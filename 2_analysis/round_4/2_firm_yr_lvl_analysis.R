...
c_exporting_controls = c('log_comp_data', 'log_comp_data_lag1', 'log_comp_total', 'log_comp_total_lag1',
                     'log_dom_turnover', 'log_dom_turnover_sq', 'avg_prestige_total', 'share_empl_college', 'log_age', 'capital_intensity')
...
write_rds(model_output, paste0(raw_output_dir,'2b.2_extensive_x_variance_extensive_margin.rds'))
