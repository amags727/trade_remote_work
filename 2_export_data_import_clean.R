...
parLapply(cl, 1:nrow(similiarity_data),function(i){
  ...
  fwrite(temp,paste0('../1) data/5_portfolio_similiarity_comps/comp_',i,'.csv'))
  return(NULL)
})
stopCluster(cl)
...
fwrite(portfolio_data_complete, '../1) data/8_portfolio_data_similiarity_matched.csv')
...
## export
fwrite(customs_data, '../1) data/9_customs_cleaned.csv')
...
fwrite(customs_data_product_level, '../1) data/10_customs_product_level_cleaned.csv')
...
fwrite(product_collapsed, '../1) data/10a_product_lvl_summary_stats.csv')
...
fwrite(country_level_data, '../1) data/11_country_level_data.csv')
...
fwrite(NACE_quartiles, '../1) data/12_domestic_industry_summary_stats.csv')
...
fwrite(export_regression_inputs, '../1) data/13a_firm_level_growth_analysis_inputs.csv')
...
fwrite(customs_data_product_level, '../1) data/13b_product_level_growth_analysis_inputs.csv')
